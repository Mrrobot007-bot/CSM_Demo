...
/**
 * An Interface for possible props for the UserInviteList component
 */
interface IUserInviteListProps {
  /**
  ...
  /**
   * Prop used to provide the callback to set list of choose users to invite
   */
  setInviteListId: (item: Array<any>) => void;
}

/**
 * UserInviteList - A component used to render a view where user
 * can invite other to join challenge
 */
export const UserInviteList: React.FC<IUserInviteListProps> = (
  props: IUserInviteListProps,
) => {
  ...
  const getSuggestions = useCallback(async q => {
    ...
    try {
      let apiResponse = await dispatch(
        postApiCall(API_URLS.INVITES_LIST, parameters),
      );
